...
class genEmbed extends EmbedBuilder {
  constructor(opt) {
    ...
    this.setFooter({
      ...
      iconURL: "https://avatars.githubusercontent.com/u/168911261?v=4",
    });
    this.setTimestamp();
  }
  /*
  ...
  üstBaşlık(options, deprecatedIconURL, deprecatedURL) {
    ...
    this.author = {
      name: verifyString(name, RangeError, "EMBED_AUTHOR_NAME"),
      url,
      iconURL,
    };
    return this;
  ...
  altBaşlık(options, deprecatedIconURL) {
    ...
    this.footer = {
      text: verifyString(text, RangeError, "EMBED_FOOTER_TEXT"),
      iconURL,
    };
    return this;
  }
